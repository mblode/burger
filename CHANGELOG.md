...
- 098a02a: Make the menu usable when the list is taller than the window.
...
- c973884: Rebuilt on native CSS and made the menu usable by keyboard.
...
- ef47d86: Publish the pending menu text transition smoothing so opened navigation text fades in and out with the rest of the menu.
